    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('Administrador', 'Administrador'), ('Gestor de Proyectos', 'Gestor de Proyectos'), ('Colaborador', 'Colaborador')], default='Colaborador', max_length=20)),
