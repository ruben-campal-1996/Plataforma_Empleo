...
SECRET_KEY = 'django-insecure-ve1b1ydc^)4qsrn&&3-#mn(j0+5y1b!x9di#acuh8mz_(jr6(#'
...
INSTALLED_APPS = [
    ...
    'Analisis_mercado.apps.AnalisisMercadoConfig',
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': '1nF0_24#',
        'HOST': 'localhost',
        'PORT': '5432',  # O el puerto de tu servidor
        'OPTIONS': {
